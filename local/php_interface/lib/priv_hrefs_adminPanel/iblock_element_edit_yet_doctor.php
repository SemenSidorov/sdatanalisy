...
$ob_cost_doctor = CIBLockElement::GetList(array("SORT"=>"ASC"), array("IBLOCK_ID"=>$IBLOCK_ID_COST_DOCTORS, "PROPERTY_87_VALUE"=>$id, "ACTIVE"=>"Y"), array("ID", "NAME", "IBLOCK_ID", "CODE", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID", "IBLOCK_TYPE_ID"), false);
...
foreach($ar_cost_doctor as $doctor){
?>
...
background_block_tr.id='tr_PROPERTY_PRIV_COST_DOCTOR_BACKGROUND';
...
block.id='tr_PROPERTY_PRIV_COST_DOCTOR';
...
tag_td_left.innerHTML ='Ссылка на стоимость приема врача:';
...
tag_a.setAttribute('name','tr_PROPERTY_PRIV_COST_DOCTOR_NAME');
...
tag_info.setAttribute('name','tr_PROPERTY_PRIV_COST_DOCTOR_DESCRIPTION');
...
//$ob_doctor = CIBLockElement::GetList(array("SORT"=>"ASC"), array("IBLOCK_ID"=>$IBLOCK_ID_DOCTORS, "ID"=>$id, "ACTIVE"=>"Y"), array("ID", "NAME", "IBLOCK_ID", "CODE", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID", "IBLOCK_TYPE_ID", "PROPERTY_3"), false);
//$doctor = $ob_doctor->Fetch();
$ob_clinic = CIBLockElement::GetList(array("SORT"=>"ASC"), array("IBLOCK_ID"=>$IBLOCK_ID_CLINIC, "PROPERTY_5"=>$id, "ACTIVE"=>"Y"), array("ID", "NAME", "IBLOCK_ID", "CODE", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID", "IBLOCK_TYPE_ID"), false);
...
let block = document.createElement('tr');
block.classList.add('bx-in-group');
block.id='tr_PROPERTY_PRIV_CLINIC_DOCTOR';
//создаем внутри него td для левой части
let tag_td_left = document.createElement('td');
tag_td_left.classList.add('adm-detail-content-cell-l');
tag_td_left.innerHTML ='Ссылка на клинику врача:';
tag_td_left.setAttribute("style","width:40%;");
block.appendChild(tag_td_left);	
// создаем тег td для правой части
let tag_td_right = document.createElement('td');
...
//создаем тег a с переменными php
let tag_a = document.createElement('a');
tag_a.setAttribute('name','tr_PROPERTY_PRIV_CLINIC_DOCTOR_NAME');
tag_a.setAttribute('href','http://sdatanalizy.dev.ddplanet.ru/bitrix/admin/iblock_element_edit.php?IBLOCK_ID='+iblock_id_tag_a+'&type='+iblock_type_tag_a+'&ID='+id_tag_a);
tag_a.setAttribute('value', '');
tag_a.setAttribute('size','30');
tag_a.innerHTML=name_tag_a;
...
// создаем див с описанием элемента
let tag_info = document.createElement('div');
tag_info.setAttribute('name','tr_PROPERTY_PRIV_CLINIC_DOCTOR_DESCRIPTION');
tag_info.setAttribute('value', '');
tag_info.setAttribute('size','30');
tag_info.setAttribute("style","display:block;position:relative;");
tag_info.innerHTML='ID элемента: '+id_tag_a+'<br>ID инфоблока: '+iblock_id_tag_a+'<br>';
