...
$ob_cost_service = CIBLockElement::GetList(array("SORT"=>"ASC"), array("IBLOCK_ID"=>$IBLOCK_ID_COST_SERVICES, "PROPERTY_37_VALUE"=>$id, "ACTIVE"=>"Y"), array("ID", "NAME", "IBLOCK_ID", "CODE", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID", "IBLOCK_TYPE_ID"), false);
...
foreach($ar_cost_service as $service){
?>
...
background_block_tr.id='tr_PROPERTY_PRIV_COST_SERVICE_BACKGROUND';
...
block.id='tr_PROPERTY_PRIV_COST_SERVICE';
...
tag_td_left.innerHTML ='Ссылка на цену услуги элемента:';
...
var name_tag_a = '<?php echo $service["NAME"];?>';
var iblock_id_tag_a='<?php echo $service["IBLOCK_ID"];?>';
var iblock_type_tag_a='<?php echo $service["IBLOCK_TYPE_ID"];?>';
var id_tag_a='<?php echo $service["ID"];?>';
...
tag_a.setAttribute('name','tr_PROPERTY_PRIV_COST_SERVICE_NAME');
...
tag_info.setAttribute('name','tr_PROPERTY_PRIV_COST_SERVICE_DESCRIPTION');
...
$ob_doctors = CIBLockElement::GetList(array("SORT"=>"ASC"), array("IBLOCK_ID"=>$IBLOCK_ID_DOCTORS, "PROPERTY_3_VALUE"=>$id, "ACTIVE"=>"Y"), array("ID", "NAME", "IBLOCK_ID", "CODE", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID", "IBLOCK_TYPE_ID"), false);
...
/*let background_block_tr = document.createElement('tr');
background_block_tr.classList.add('heading');
background_block_tr.id='tr_PROPERTY_PRIV_DOCTORS_BACKGROUND';
obj.appendChild(background_block_tr);
...
let block = document.createElement('tr');
block.classList.add('bx-in-group');
block.id='tr_PROPERTY_PRIV_DOCTORS';
//создаем внутри него td для левой части
let tag_td_left = document.createElement('td');
tag_td_left.classList.add('adm-detail-content-cell-l');
tag_td_left.innerHTML ='Ссылка на врача элемента:';
tag_td_left.setAttribute("style","width:40%;");
block.appendChild(tag_td_left);	
// создаем тег td для правой части
let tag_td_right = document.createElement('td');
...
tr.appendChild(td);
//берем полученные переменные из php
var name_tag_a = '<?php echo $doctor["NAME"];?>';
var iblock_id_tag_a='<?php echo $doctor["IBLOCK_ID"];?>';
var iblock_type_tag_a='<?php echo $doctor["IBLOCK_TYPE_ID"];?>';
var id_tag_a='<?php echo $doctor["ID"];?>';
//var section_name_tag_a='<?php echo $analyz["SECTION_NAME"];?>';
//var section_id__tag_a='<?php echo $analyz["SECTION_ID"];?>';
//создаем тег a с переменными php
let tag_a = document.createElement('a');
tag_a.setAttribute('name','tr_PROPERTY_PRIV_DOCTOR_NAME');
tag_a.setAttribute('href','http://sdatanalizy.dev.ddplanet.ru/bitrix/admin/iblock_element_edit.php?IBLOCK_ID='+iblock_id_tag_a+'&type='+iblock_type_tag_a+'&ID='+id_tag_a);
tag_a.setAttribute('value', '');
tag_a.setAttribute('size','30');
tag_a.innerHTML=name_tag_a;
...
// создаем див с описанием элемента
let tag_info = document.createElement('div');
tag_info.setAttribute('name','tr_PROPERTY_PRIV_DOCTOR_DESCRIPTION');
tag_info.setAttribute('value', '');
tag_info.setAttribute('size','30');
tag_info.setAttribute("style","display:block;position:relative;");
tag_info.innerHTML='ID элемента: '+id_tag_a+'<br>ID инфоблока: '+iblock_id_tag_a+'<br>';
