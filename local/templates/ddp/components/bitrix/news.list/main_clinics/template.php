...
$cityAreas = array();
?>
<div class="m-clinics" id="m_clinics-id">
        ...
        <div class="search-clinics__search-panel">
            <div class="search-clinics__search-panel-list">
                ...
                <script>
					...
					//document.getElementById('search-clinics__map_points').setAttribute("style","position:absolute;width:50%;height:100%;right:0;");
		//document.getElementById('mapPoints').setAttribute("style","position:absolute;width:50%;height:100%;right:0;");
		///document.getElementById('m_clinics-id').setAttribute("style","position:absolute;width:100%;height:100%;right:0;");
                </script>
            </div>
        </div>
