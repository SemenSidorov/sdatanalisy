...
<script>  //Неодходимо инициализировать города и районы по такой структуре. Они используются в map-points.js
                    cities = [];
                    cityAreas = [
...
//var SecondVar = 50;
	...
	let elum;
	//var pagetitle = document.querySelector('.ymaps-2-1-77-gototech');
	elum =	Array.from(document.getElementsByClassName('ymaps-2-1-77-gototech'));
			//alert(elum);
	//document.getElementsByClassName('ymaps-2-1-77-gototech').className = 'ymaps_mobile_gototech';
}, 50);</script>
