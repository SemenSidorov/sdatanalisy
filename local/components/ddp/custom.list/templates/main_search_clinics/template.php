            ...
            <div class="search-clinics__search-panel-list">
                ...
                <!-- <div class="search-clinics__search-panel-item search-clinics__search-panel-item--select">
                   <select class="js-search-clinic--select" data-placeholder="Выберите район">
                    ...
                    cities = [
                        { value: "Москва", id: 1 },
                        { value: "Санкт-Петербург", id: 2 },
                    ];
                    cityAreas = [
                        { id: -1, text: "Выберите район" },
                        { id: 1, cityId: 1, text: "Район 1 Москвы" },
                        { id: 2, cityId: 1, text: "Район 2 Москвы" },
                        { id: 3, cityId: 2, text: "Район 1 Санкт-Петербурга" },
                        { id: 4, cityId: 2, text: "Район 2 Санкт-Петербурга" },
                    ];
                </script>
            </div>
        </div>
